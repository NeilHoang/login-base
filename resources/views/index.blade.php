...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="card mb-4 col-12">
            <img class="card-img-top" src="https://haroldwrites.files.wordpress.com/2017/04/blog2.png" alt="Card image cap">
            <div class="card-body">
        ...
        <!-- footer area start-->
        <div class="card mb-4 col-12">
            <img class="card-img-top" src="https://vn.blog.kkday.com/wp-content/uploads/8f3d4681-3b4f-49f1-bad4-d1a540cde1f0.jpg" alt="Card image cap">
            <div class="card-body">
                <h2 class="card-title">Post Title</h2>
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
                <a href="#" class="btn btn-primary">Read More &rarr;</a>
